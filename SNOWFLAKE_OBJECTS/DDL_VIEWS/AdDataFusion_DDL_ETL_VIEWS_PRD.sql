--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_CHANGES_TO_CD2_AD AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_CHANGES_TO_CD2_ADSET AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_CHANGES_TO_CD2_CAMPAIGN AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_FS_ADS_AGE_AND_GENDER AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_FS_ADS_COUNTRY AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_FS_ADS_DMA AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_FS_ADS_HOURLY_ADVERTISER AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_FS_ADS_PLATFORM_AND_DEVICE AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.FACEBOOK_ADS.VW_FS_ADS_REGION AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.GOOGLE_ADS.VW_FS_GOOGLE_ADS_PERFORMANCE_ACCOUNT AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.GOOGLE_ADS.VW_FS_GOOGLE_ADS_PERFORMANCE_CAMPAIGN AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.GOOGLE_ADS.VW_FS_GOOGLE_ADS_PERFORMANCE_CLICK AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.LINKEDIN.VW_LINKEDIN_FS_ADS_ANALYTICS_BY_CAMPAIGN AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.LINKEDIN.VW_LINKEDIN_FS_ADS_ANALYTICS_BY_CREATIVE AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.TIKTOK_ADS.VW_FS_ADS_INSIGHTS_AGE_AND_GENDER AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.TIKTOK_ADS.VW_FS_ADS_INSIGHTS_COUNTRY AS
...
--##############################################################################
CREATE OR REPLACE VIEW ADDDATAFUSION.TIKTOK_ADS.VW_FS_ADS_INSIGHTS_PLATFORM AS
